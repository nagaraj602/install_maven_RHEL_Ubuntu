...
cd; sudo yum install git -y > /dev/null; git clone https://github.com/nagaraj602/install_maven_RHEL_Ubuntu.git &> /dev/null; cd install_maven_RHEL_Ubuntu; bash tomcat.sh
